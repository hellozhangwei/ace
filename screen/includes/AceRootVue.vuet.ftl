...
<#--<div id="apps-root">-->
    ...
    <input type="hidden" id="confLinkBasePath" value="${ec.web.servletContext.contextPath}/aceapps">
                ...
                <ul class="submenu">
                    ...
                    <li class="">
                        <a href="/apps">
                           ...
                           <#--<m-link :href="getNavHref(menuIndex)">test <i class="glyphicon glyphicon-chevron-right"></i></m-link>-->
                        <b class="arrow"></b>
                    </li>
...
<#--
<div id="apps-root">&lt;#&ndash; NOTE: webrootVue component attaches here, uses this and below for template &ndash;&gt;
    <input type="hidden" id="confMoquiSessionToken" value="${ec.web.sessionToken}">
    <input type="hidden" id="confAppHost" value="${ec.web.getHostName(true)}">
    <input type="hidden" id="confAppRootPath" value="${ec.web.servletContext.contextPath}">
    <input type="hidden" id="confBasePath" value="${ec.web.servletContext.contextPath}/apps">
    ...
    <#list navbarCompList! as navbarCompUrl><input type="hidden" class="confNavPluginUrl" value="${navbarCompUrl}"></#list>
    <#if hideNav! != 'true'>
    <div id="top"><nav class="navbar navbar-inverse">&lt;#&ndash;  navbar-fixed-top navbar-static-top &ndash;&gt;<div class="container-fluid">
        ...
        <div id="navbar-buttons" class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            &lt;#&ndash; screen history menu &ndash;&gt;
            &lt;#&ndash; get initial history from server? <#assign screenHistoryList = ec.web.getScreenHistory()><#list screenHistoryList as screenHistory><#if (screenHistory_index >= 25)><#break></#if>{url:pathWithParams, name:title}</#list> &ndash;&gt;
            ...
            &lt;#&ndash; screen history previous screen &ndash;&gt;
